...
L<Net::LDAP::Search|Net::LDAP::Search> package. By calling methods on 
...
Since this is a proprietrary feature, you will have to check your
...
The code required will look similiar to the following code snippet.
...
$Id: FAQ.pod,v 1.13 2001/05/15 02:45:13 charden Exp $
