...
As L<IO::Socket::IP> does not support timeouts and recent versions
of L<IO::Socket::SSL> prefer L<IO::Socket::IP> when it is installed,
this option may not be fully supported on LDAPS connections.
