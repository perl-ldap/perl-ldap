...
Chris Ridd <chris.ridd@messagingdirect.com> for the many hours spent
testing and contribution of the ldap* command line utilities.

=head1 MAILING LIST

A discussion mailing list is hosted by sourceforge at
<perl-ldap-dev@lists.sourceforge.net> Don't be put off by the -dev
...
I<$Id: LDAP.pod,v 1.20 2003/05/06 11:52:40 chrisridd Exp $>
