...
The B<add> option should be a reference to a HASH. The keys of the
...
OPTIONS is a number of key-value pairs which describe how to
...
I<$Id: LDAP.pod,v 1.32 2003/05/23 07:07:31 chrisridd Exp $>
